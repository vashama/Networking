...
if(!empty($_POST['email']))   //checking the 'email' which is from sign_in.html
{
	...
	if(!empty($row['email']) AND !empty($row['password']))
	{
		...
		header('Location: localhost/main page/admin/monitoring.html'); 
        //echo "<b><center><h1>LOG IN SUCCESSFUL</h1></b></br/></center>";
          //      echo '<br/><a href="admin/monitoring.html"><b><center><h2>CONTINUE</h2></b></center></a>';

	}
	else
	{
	        echo "<b><center><h1>SORRY... YOU HAVE ENTERED WRONG EMAIL ADDRESS AND PASSWORD... PLEASE TRY AGAIN..</h1></b></center>";
                //echo '<br/><br/><a href="sign_in.html"><b><center><h2 style="color: midnightblue;">GO BACK<h2></center></b></a>';
	}
}
/*
