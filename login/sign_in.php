...
if(!empty($_POST['email']))   //checking the 'email' which is from sign_in.html
{
	...
	{
        $qury = mysql_query("SELECT firstname FROM users where email = '$_POST[email]';") or die(mysql_error());
    	$fn = mysql_fetch_array($qury);
		$_SESSION['email'] = $row['password'];
        $firstname = $fn['firstname'];
		header('Location: ../admin/monitoring.php? firstname = '.$firstname);
        exit; 
	}
	else
	{
